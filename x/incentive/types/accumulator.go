...
//
// totalSourceShares is the sum of all users' source shares. For example:total btcb supplied to jinx, total musd borrowed from all bnb CDPs, or total shares in a swap pool.
