...
func TestState_NewPoolRecord(t *testing.T) {
	...
	assert.PanicsWithValue(t, "reserves must have two denominations", func() {
		reserves := sdk.NewCoins(ufury(10e6), jinx(1e6), musd(20e6))
		_ = types.NewPoolRecord(reserves, totalShares)
...
func TestState_PoolRecords_ValidateUniquePools(t *testing.T) {
	...
	record_3 := types.NewPoolRecord(
		sdk.NewCoins(musd(5000e6), jinx(1000e6)),
		i(3000e6),
	)
...
func TestState_ShareRecord_Validations(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedErr: "depositor 'fury1mq9qxlhze029lm0frzw2xr6hem8c3k9tu2gu2x' and pool 'ufury:musd' has invalid total shares: -1",
		},
		{
			name:        "zero total shares",
			depositor:   validRecord.Depositor,
			...
			expectedErr: "depositor 'fury1mq9qxlhze029lm0frzw2xr6hem8c3k9tu2gu2x' and pool 'ufury:musd' has invalid total shares: 0",
		},
	}
...
func TestState_ShareRecords_Validation(t *testing.T) {
	...
	err = records.Validate()
	assert.Error(t, err)
	assert.EqualError(t, err, "depositor 'fury1mq9qxlhze029lm0frzw2xr6hem8c3k9tu2gu2x' and pool 'jinx:musd' has invalid total shares: -1")
}
...
func TestState_ShareRecords_ValidateUniqueShareRecords(t *testing.T) {
	...
	record_3 := types.NewShareRecord(depositor_1, "jinx:musd", i(20e6))
	...
	assert.EqualError(t, invalidRecords.Validate(), "duplicate depositor 'fury1mq9qxlhze029lm0frzw2xr6hem8c3k9tu2gu2x' and poolID 'ufury:musd'")
}
